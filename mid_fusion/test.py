...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='C:/Users/letri/Documents/cuong/IR_RGB_Detect/runs/train/exp14/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='C:/Users/letri/Documents/cuong/IR_RGB_Detect/data/multispectral/custom.yaml', help='*.data path')
    ...
    p = "C:/Users/letri/Documents/project/mid_fusion/ICA_block/IR_RGB_Detect/RGB_IR_dataset/test/labels"
