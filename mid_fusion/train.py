...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    labels_path = "RGB_IR_dataset"+ '/' + 'val/' + 'labels'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='C:\\Users\\letri\\Documents\\cuong\\IR_RGB_Detect\\models\\transformer\\yolov5s_Transfusion_FLIR.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='C:\\Users\\letri\\Documents\\cuong\\IR_RGB_Detect\\data\\multispectral\\custom.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='C:\\Users\\letri\\Documents\\cuong\\IR_RGB_Detect\\data\\hyp.scratch_VEDAI.yaml', help='hyperparameters path')
